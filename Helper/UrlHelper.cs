...
namespace dotnet_server.Helper
{
    /// <summary>
    /// URL的操作类
    /// </summary>
    public class UrlHelper
    {
        ...
        /// 将URL参数，解析为数组
        /// </summary>
        /// <param name="query">get参数</param>
        /// <param name="nvc">返回的数组</param>
        public static void ParseUrlQuery(string query , out NameValueCollection nvc)
        {
            nvc = new NameValueCollection();
            Regex re = new Regex(@"(^|&)?(\w+)=([^&]+)(&|$)?", RegexOptions.Compiled);
